...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.paths(PathSelectors.regex("/api/deals.*")).build().apiInfo(getApiInfo())
	...
	private ApiInfo getApiInfo() {
		return new ApiInfoBuilder()
				.title("Daily Deals REST API")
				.description("An REST API for fetch public and private Daily Deals.")
				.version("1.0")
